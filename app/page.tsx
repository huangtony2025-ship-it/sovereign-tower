...
import { site, gameStats, videos, pageContent } from '@/lib/data';
...
export const metadata: Metadata = {
  ...
  alternates: { languages: { th: `${site.url}/th` } },
};
  ...
  return (
    <>
      <section className="hero">
        <div className="container">
          ...
          <div className="cta-row">
            <a className="cta" href="/codes">
              {pageContent.hero.ctaCodes}
            </a>
            <a className="cta ghost" href="/guides/beginner-guide">
              {pageContent.hero.ctaBeginner}
            </a>
            <a className="cta ghost" href="/tier-list">
      ...
      <section className="section">
        <div className="container">
          <h2>{pageContent.home?.videosTitle ?? 'Latest Videos'}</h2>
          <div className="grid">
            {videos.map((v) => (
      ...
      <section className="section">
        <div className="container">
          <h2>{pageContent.home?.popularTitle ?? 'Popular Pages'}</h2>
          <div className="grid">
      ...
      <section className="section">
        <div className="container">
          <h2>{pageContent.home?.aboutTitle ?? `What is ${site.name}?`}</h2>
          <div className="prose">
