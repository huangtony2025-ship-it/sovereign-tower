...
import { site, loadoutPriority, skillTreeOrder, pageContent } from '@/lib/data';

export const metadata: Metadata = {
  title: pageContent.builds.metaTitle ?? `${site.name} Best Build & Loadout`,
  description:
    pageContent.builds.metaDesc ?? `${site.name} best loadout: the meta build, optimal upgrade path, and the skill tree spending order.`,
  alternates: { languages: { th: `${site.url}/th/builds` } },
};
      ...
      <section style={{ marginTop: 24 }}>
        ...
        <div style={{ overflowX: 'auto', marginTop: 16 }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.92rem' }}>
            <thead>
              <tr>
                <th style={{ border: '1px solid #2a2a3d', padding: '10px 12px', textAlign: 'left' }}>{pageContent.builds.upgradeCol ?? 'Upgrade'}</th>
                <th style={{ border: '1px solid #2a2a3d', padding: '10px 12px', textAlign: 'left' }}>{pageContent.builds.effectCol ?? 'Effect'}</th>
                <th style={{ border: '1px solid #2a2a3d', padding: '10px 12px', textAlign: 'left' }}>{pageContent.builds.whenCol ?? 'When to Pick'}</th>
              </tr>
            </thead>
            <tbody>
      ...
      <section style={{ marginTop: 32 }}>
        ...
        <div style={{ overflowX: 'auto', marginTop: 16 }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.92rem' }}>
            <thead>
              <tr>
                <th style={{ border: '1px solid #2a2a3d', padding: '10px 12px', textAlign: 'left' }}>{pageContent.builds.priorityCol ?? 'Priority'}</th>
                <th style={{ border: '1px solid #2a2a3d', padding: '10px 12px', textAlign: 'left' }}>{pageContent.builds.skillCol ?? 'Skill'}</th>
              </tr>
            </thead>
            <tbody>
